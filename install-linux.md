...
- WineHQ PGP key block below comes from:
  <https://dl.winehq.org/wine-builds/winehq.key>
- Ubuntu Noble sources:
  <https://dl.winehq.org/wine-builds/ubuntu/dists/noble/winehq-noble.sources>

### wine from Ubuntu packages

- This will be somewhat out-of-date.

- Prepare for `i386` support:
...
- Install Wine signing key:
      ...
      =NUWj
      -----END PGP PUBLIC KEY BLOCK-----
      ' | gpg --dearmor --yes -o /etc/apt/keyrings/winehq.gpg

- Install WineHQ APT sources:
...
- (one-time) Acquire key:

      curl https://downloads.claude.ai/keys/claude-code.asc
...
- Dearmor Oracle 2016 key into `/etc/apt/keyrings/claude-code.gpg`:
    ...
    echod '
      ...
      =oqMI
      -----END PGP PUBLIC KEY BLOCK-----
    ' | gpg --dearmor --yes -o /etc/apt/keyrings/claude-code.gpg

- Create a `.sources` file for claude-code:

      echod -o /etc/apt/sources.list.d/claude-code.sources "
        Types: deb
...
- Monitoring:
  ...
  - (TODO: testing this) `claude-monitor`:
